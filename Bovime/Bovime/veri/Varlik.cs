...
namespace Bovime.veri
{
    public class Varlik : DbContext
    {
        ...
        public virtual DbSet<IletisimTalebiAYRINTI> IletisimTalebiAYRINTIs { get; set; }
        public virtual DbSet<IletisimTalebi> IletisimTalebis { get; set; }
        public virtual DbSet<SikSorulanSorularAYRINTI> SikSorulanSorularAYRINTIs { get; set; }
        public virtual DbSet<SikSorulanSorular> SikSorulanSorulars { get; set; }
        public virtual DbSet<FirmaBasvurusuAYRINTI> FirmaBasvurusuAYRINTIs { get; set; }
        public virtual DbSet<FirmaBasvurusu> FirmaBasvurusus { get; set; }
        public virtual DbSet<AltMenuAYRINTI> AltMenuAYRINTIs { get; set; }
