...
namespace Bovime.veri
{
    public partial class KullaniciRoluAYRINTI : Bilesen
    {
        ...
        public static async Task<KullaniciRoluAYRINTI?> bul(veri.Varlik vari, params Expression<Func<KullaniciRoluAYRINTI, bool>>[] kosullar)
        {
            return await veriTabani.KullaniciRoluAYRINTICizelgesi.bul(vari, kosullar);
        }
