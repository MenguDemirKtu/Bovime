...
namespace Bovime.veri
{
    public partial class FirmaKampanyasi : Bilesen
    {
        ...
        {
            if (string.IsNullOrEmpty(this.kampanyaKodu))
                kampanyaKodu = Guid.NewGuid().ToString();
        ...
        public enumref_KampanyaDurumu _Kampanyadurumu
        {
            get
            {
                return (enumref_KampanyaDurumu)this.i_kampanyaDurumuKimlik;
            }
            set
            {
                i_kampanyaDurumuKimlik = (int)value;
            }
        }
