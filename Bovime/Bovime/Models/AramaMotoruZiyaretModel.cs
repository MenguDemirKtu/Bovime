...
public async Task veriCekKos(Yonetici kime, long kimlik) 
 ...
 public List<AramaMotoruAYRINTI> _ayAramaMotoruAYRINTI { get; set; } public async Task baglilariCek(veri.Varlik vari, Yonetici kim) {   _ayAramaMotoruAYRINTI = await AramaMotoruAYRINTI.ara(vari);}
