...
{
    public class SatisAYRINTIModel : ModelTabani
    {
        public SatisAYRINTI kartVerisi { get; set; }
        public List<SatisAYRINTI> dokumVerisi { get; set; }
        public SatisAYRINTIArama aramaParametresi { get; set; }


        public SatisAYRINTIModel()
        {
            this.kartVerisi = new SatisAYRINTI();
        ...
        public async Task silKos(Sayfa sayfasi, string id, Yonetici silen)
        {
            using (veri.Varlik vari = new veri.Varlik())
            {
                ...
                {
                    SatisAYRINTI? silinecek = await SatisAYRINTI.olusturKos(vari, kayitlar[i]);
                    if (silinecek == null)
                        continue;
                    silinecek._sayfaAta(sayfasi);
                }
            }
            Models.SatisAYRINTIModel modeli = new Models.SatisAYRINTIModel();
        ...
        public async Task veriCekKos(Yonetici kime, long kimlik)
        {
            ...
            {
                var kart = await SatisAYRINTI.olusturKos(vari, kimlik);
                if (kart != null)
                    kartVerisi = kart;
